...
using DotnetMsSqlCICD.Api.Filters;
using DotnetMsSqlCICD.Business.Installer;

namespace DotnetMsSqlCICD.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotnetMsSqlCICD API", Version = version + "-" + branch });
        });
