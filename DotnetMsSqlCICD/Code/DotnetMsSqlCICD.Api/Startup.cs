using DotnetMsSqlCICD.Api.Installer;
using DotnetMsSqlCICD.Api.Middleware;
using DotnetMsSqlCICD.Data.Repositories;
...
using System;
using DotnetMsSqlCICD.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace DotnetMsSqlCICD.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "DotnetMsSqlCICD V1");
        });
